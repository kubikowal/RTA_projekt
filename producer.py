...
def send_weather_data(producer, city, weather_data):
    ...
    humidity = weather_data['day'].get('avghumidity', 'N/A')
    wind_kph = weather_data['day'].get('maxwind_kph', 'N/A')
    date = weather_data['date']
    print(f"Sent data for {city}: {date} => {avg_temp} *C, {humidity}% humidity, {wind_kph} kph wind")
